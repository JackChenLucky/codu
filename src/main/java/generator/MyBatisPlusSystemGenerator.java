 ...
 */
public class MyBatisPlusSystemGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir("D:\\Testroom\\BuildCode");//这里写你自己的java目录
        ...
        dsc.setUsername("codu");
        dsc.setPassword("codu");
        dsc.setUrl("jdbc:oracle:thin:@192.168.10.60:1521:his");
